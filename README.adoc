...
This repository customises a {library}[Spring Initializr] instance with a custom UI
running at https://axon-initializr.cfapps.io. The following modules are available:
